        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Pendaftaran Kursus Membuat Kue</h1>
            </div>
            ...
            <div class="row">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form id="registrationForm" action="{{ route('create') }}" method="POST">
                                ...
                                <input type="hidden" value="cake" name="kursus" id="kursus">
                ...
                <div class="col-lg-6 mb-4">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <p>Kursus Membuat Kue ini dirancang untuk pemula maupun yang sudah berpengalaman dalam membuat kue. Anda akan belajar berbagai teknik dan resep yang bervariasi.</p>
