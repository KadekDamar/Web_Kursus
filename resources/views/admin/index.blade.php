    ...
    <div id="wrapper">
      ...
      >
        ...
        <li class="nav-item active">
          <a class="nav-link" href="{{ Auth::user()->role }}">
                    ...
                    <div class="col-lg-12 mb-4">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Berita Website Saat Ini</h6>
                            </div>
                            <div class="card-body">
                                <p>{{ $berita->konten }}</p>
                                <div class="d-grid gap-2">
                                    <!-- Button trigger modal -->
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#editBeritaModal">
                                        <i class="fas fa-arrow-right mr-2"></i> Ubah Berita Website
                                    </button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="editBeritaModalLabel">Ubah Berita Website</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <form action="{{ route('admin.updateBerita') }}" method="POST">
                            @csrf
                            <div class="modal-body">
                                <div class="form-group">
                                    <label for="konten">Berita</label>
                                    <textarea class="form-control" id="konten" name="konten" rows="5">{{ $berita->konten }}</textarea>
                                </div>
                            </div>
