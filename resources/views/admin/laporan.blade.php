      ...
      <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
          ...
          <div class="container-fluid">
            <h1 class="h3 mb-2 text-gray-800">Laporan Pengajuan Pengguna</h1>
            <p class="mb-3">Laporan pengguna <span class="text-info">yang mengajukan</span> untuk mengikuti <span class="text-success">kursus</span>! .</p>
                <div class="d-sm-flex align-items-center justify-content-between mb-3">
                    <form action="{{ route('generateLaporanAdminPdf') }}" method="POST">
                        @csrf
                                ...
                                <tbody>
                                    @foreach ($data as $pengguna)
                                        <tr>
                                            ...
                                            <td>{{ $pengguna->alasan }}</td>
                                            <td>{{ $pengguna->kursus }}</td>
